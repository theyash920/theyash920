...
export default function HomeScreen() {
  ...
  const stopRecording = async () => {
    try {
      ...
      // send the transcript to Groq API for response
  ...
  const sendToGroq = async (text: string) => {
    try {
          ...
          messages: [
            {
              role: "system",
              content:
                "You are IIITDELHI, a friendly AI assistant who responds naturally and refers to yourself as IIITDELHI when asked for your name. You are a helpful assistant who can answer questions and help with tasks. You must always respond in English, no matter the input language, and provide helpful, clear answers",
            },
            {
              role: "user",
              content: text,
      ...
      console.log("Error sending text to Groq", error);
    }
  };
